-- ============================================
-- MIGRATION 020: FIX SYSTEM HEALTH CHECK
-- Description: Resolve ambiguous column references in system_health_check
-- Version: 1.0
-- Date: 2026-02-16
...
SELECT 'Sprint 3 health check fix applied' AS status, NOW() AS executed_at;
